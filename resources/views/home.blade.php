...
<div class="min-h-full">
    ...
    <header class="bg-white shadow-sm">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Cryptography</h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="flex gap-[20px] flex-row flex-nowrap justify-start items-stretch content-stretch">
          <div class="grow">
            <form class="max-w-sm mx-auto">
              ...
              <div class="mb-5">
                ...
                <input type="text" id="plain-text" class="block w-full p-4 text-gray-900 border border-white-300 rounded-lg bg-white-50 text-base">
              </div>
              <div class="mb-5">
                  <label for="secret-key-aes" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Secret Key</label>
                  <input type="text" id="secret-key-aes" class="block w-full p-2 text-gray-900 border border-white-300 rounded-lg bg-white-50 text-base">
              </div>
          ...
          <div class="grow">
            <form class="max-w-sm mx-auto">
              ...
              <div class="mb-5">
                  <label for="plain-text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Plain Text</label>
                  <input type="text" id="large-input" class="block w-full p-4 text-gray-900 border border-white-300 rounded-lg bg-white-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              </div>
              <div class="mb-5">
                <label for="secret-key-aes" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray">Secret Key</label>
